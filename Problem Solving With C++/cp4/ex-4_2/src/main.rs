...
fn main() {
    loop {
        ...
        println!("Hat size: {}", calculate_hat_size(weight, height));
        println!("Cloth size: {}", calculate_cloth_size(weight, height, age));
        println!("Waistline: {}", calculate_waistline(weight, age));
